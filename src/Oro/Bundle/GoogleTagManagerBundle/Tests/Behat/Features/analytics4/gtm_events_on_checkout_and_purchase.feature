...
Feature: GTM events on checkout and purchase
  ...
  Scenario: Feature background
    ...
    When I follow "System/Integrations/Google Settings" on configuration sidebar
    Then I should not see "Data Collection for"
    When I enable GTM integration
    And reload the page
    ...
    Then I should see validation errors:
      | Data Collection for | This value should not be blank. |
    When fill form with:
